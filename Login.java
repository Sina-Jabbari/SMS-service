...
public class Login extends HttpServlet {
   ...
   @Override
    ...
    private UserInfo getUserInfo(String uname, String password) {
         ...
         */
        UserInfo uf= new UserInfo("test","test");
   
        
       try {
           uf.addBook(new BookBorrowed("", "oanunoby", new SimpleDateFormat("yyyy-MM-dd").parse("2021-02-01"), true));
           uf.addBook(new BookBorrowed("", "kawhisklawset", new SimpleDateFormat("yyyy-MM-dd").parse("2024-02-02"), false));
